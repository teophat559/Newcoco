...
$error_info = [
    ...
    'reasons' => [
        ...
        'Kết nối mạng chậm',
        'Xử lý yêu cầu mất nhiều thời gian',
        'Tài nguyên hệ thống không đủ'
    ],
    'actions' => [
        'Thử lại sau vài giây',
        'Kiểm tra kết nối mạng',
        'Giảm kích thước dữ liệu gửi lên',
...
<head>
    ...
    <title>Hết thời gian chờ - <?php echo SITE_NAME; ?></title>
    ...
    <div class="error-container">
        ...
        <div class="error-details">
            <div class="request-info">
                ...
                <p>Thời gian xử lý: <?php echo number_format($error_info['request_info']['time'], 2); ?> giây</p>
                <p>Thời gian chờ: <?php echo $error_info['timeout']; ?> giây</p>
            </div>
