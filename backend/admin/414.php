...
$error_info = [
    'title' => 'URI quá dài',
    'message' => 'Đường dẫn yêu cầu của bạn vượt quá giới hạn cho phép.',
    'reasons' => [
        'URL chứa quá nhiều tham số',
        'Tham số URL quá dài',
        'Đường dẫn chứa ký tự đặc biệt',
        'URL được mã hóa không đúng cách'
    ],
    'actions' => [
        'Rút gọn URL',
    ...
    'limits' => [
        'max_uri_length' => '2048 ký tự',
        'max_query_length' => '1024 ký tự',
        'max_params' => 50
    ],
    'request_info' => [
...
$log_message = sprintf(
    ...
    $error_info['request_info']['uri_length'],
    $error_info['request_info']['query_string']
);
...
<head>
    ...
    <title>URI quá dài - <?php echo SITE_NAME; ?></title>
    ...
    <div class="error-container">
        ...
        <div class="error-details">
            <div class="limits-info">
                <h5>Giới hạn hệ thống</h5>
                <p>Độ dài URI tối đa: <?php echo $error_info['limits']['max_uri_length']; ?></p>
                <p>Độ dài query string tối đa: <?php echo $error_info['limits']['max_query_length']; ?></p>
                <p>Số lượng tham số tối đa: <?php echo $error_info['limits']['max_params']; ?> tham số</p>
            </div>
            ...
            <div class="request-info">
                ...
                <p>URI Length: <?php echo $error_info['request_info']['uri_length']; ?> ký tự</p>
                <p>Query String: <?php echo $error_info['request_info']['query_string']; ?></p>
            </div>
