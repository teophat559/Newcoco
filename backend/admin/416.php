...
$error_info = [
    ...
    'message' => 'Yêu cầu của bạn nằm ngoài phạm vi cho phép.',
    'reasons' => [
        'Phạm vi yêu cầu không hợp lệ',
        'Phạm vi không được hỗ trợ',
        'Phạm vi vượt quá giới hạn',
        'Phạm vi không khớp với tài nguyên'
    ],
    'actions' => [
        'Kiểm tra lại phạm vi yêu cầu',
        'Điều chỉnh phạm vi trong giới hạn',
        'Liên hệ quản trị viên',
        'Thử lại với phạm vi khác'
    ],
    ...
    'range_info' => [
        'requested_range' => $_SERVER['HTTP_RANGE'] ?? 'N/A',
        'content_length' => $_SERVER['CONTENT_LENGTH'] ?? 0,
        'content_type' => $_SERVER['CONTENT_TYPE'] ?? 'N/A',
        'resource_size' => '100MB',
        'max_range_size' => '10MB',
        'supported_ranges' => ['bytes', 'items']
    ],
    'request_info' => [
        'method' => $_SERVER['REQUEST_METHOD'],
        'uri' => $_SERVER['REQUEST_URI'],
        'range_header' => $_SERVER['HTTP_RANGE'] ?? 'N/A',
        'if_range' => $_SERVER['HTTP_IF_RANGE'] ?? 'N/A'
    ]
];
...
$log_message = sprintf(
    ...
    $error_info['request_info']['range_header'],
    $error_info['request_info']['if_range']
);
...
<head>
    ...
    <title>Phạm vi không thỏa mãn - <?php echo SITE_NAME; ?></title>
    ...
    <div class="error-container">
        ...
        <div class="error-details">
            <div class="range-info">
                <h5>Thông tin phạm vi</h5>
                <div class="range-limits">
                    <div class="range-limit">
                        <h6>Kích thước tài nguyên</h6>
                        <p><?php echo $error_info['range_info']['resource_size']; ?></p>
                    </div>
                    <div class="range-limit">
                        <h6>Phạm vi tối đa</h6>
                        <p><?php echo $error_info['range_info']['max_range_size']; ?></p>
                    </div>
                    <div class="range-limit">
                        <h6>Phạm vi được hỗ trợ</h6>
                        <p><?php echo implode(', ', $error_info['range_info']['supported_ranges']); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="request-info">
                ...
                <p>Range: <?php echo $error_info['request_info']['range_header']; ?></p>
                <p>If-Range: <?php echo $error_info['request_info']['if_range']; ?></p>
            </div>
