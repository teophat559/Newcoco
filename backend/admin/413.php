...
// Thông tin lỗi
$error_info = [
    'title' => 'Yêu cầu quá lớn',
    'message' => 'Kích thước yêu cầu của bạn vượt quá giới hạn cho phép.',
    'reasons' => [
        'Kích thước file tải lên quá lớn',
        'Dữ liệu gửi lên vượt quá giới hạn',
        'Nhiều file được tải lên cùng lúc',
...
$log_message = sprintf(
    ...
    $error_info['request_info']['content_length'],
...
<head>
    ...
    <title>Yêu cầu quá lớn - <?php echo SITE_NAME; ?></title>
    ...
    <div class="error-container">
        ...
        <div class="error-details">
            <div class="limits-info">
                ...
                <p>Kích thước file tối đa: <?php echo $error_info['limits']['max_file_size']; ?></p>
                <p>Kích thước dữ liệu tối đa: <?php echo $error_info['limits']['max_post_size']; ?></p>
                <p>Số lượng file tối đa: <?php echo $error_info['limits']['max_upload_files']; ?> files</p>
            </div>

            <div class="request-info">
                <h5>Thông tin yêu cầu</h5>
                <p>Method: <?php echo $error_info['request_info']['method']; ?></p>
                <p>Content Length: <?php echo $error_info['request_info']['content_length']; ?> bytes</p>
