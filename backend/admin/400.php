...
$error_info = [
    ...
    'message' => 'Yêu cầu của bạn không được xử lý do dữ liệu không hợp lệ.',
    'reasons' => [
...
<head>
    ...
    <title>Yêu cầu không hợp lệ - <?php echo SITE_NAME; ?></title>
    ...
    <div class="error-container">
        ...
        <div class="error-details">
            <div class="error-info">
                ...
                <div>Method: <?php echo $error_info['request_method']; ?></div>
                <div>URI: <?php echo $error_info['request_uri']; ?></div>
            </div>
